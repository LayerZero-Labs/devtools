...
module oft::oft_adapter_coin_tests {
    ...
    fun setup() {
        // Initialize AptosCoin - some of the coin internals checks require that AptosCoin is initialized
    ...
    fun test_debit() {
        ...
        placeholder_coin::burn_for_test(coin);
    ...
    fun test_credit() {
        ...
        placeholder_coin::burn_for_test(deposit);
    ...
    fun test_set_fee_bps() {
        ...
        placeholder_coin::burn_for_test(coin_value);
    ...
    fun test_set_blocklist_debit() {
        ...
        std::aptos_account::deposit_coins(blocklisted_address, placeholder_coin::mint_for_test(10_000));
        ...
        placeholder_coin::burn_for_test(debit_tokens);
    }
