...
// Example: pnpm hardhat lz:oft:solana:nilify --eid 40168 --sender <SENDER_OAPP> --receiver <RECEIVER_OAPP> --src-eid 4016140161 --nonce <NONCE> --payload-hash <PAYLOAD_HASH>
