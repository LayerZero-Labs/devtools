...
import { localDecimalsToMaxSupplyWholeTokens } from './utils'
...
task('lz:oft-adapter:solana:create', 'Creates new OFT Adapter (OFT Store PDA)')
    ...
    .setAction(
        async ({
            ...
            const maxSupplyStatement = `You provided Token Mint ${mintDecimals} local decimals. The maximum supply of your Solana OFT token will be ${localDecimalsToMaxSupplyWholeTokens(mintDecimals)}.\n`
