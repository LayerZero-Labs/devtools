...
impl WithdrawRent {
  pub fn instruction(&self, args: WithdrawRentInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawRentInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&WithdrawRentInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct WithdrawRentInstructionData {
            discriminator: [u8; 8],
            }

impl WithdrawRentInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [226, 7, 41, 158, 173, 111, 192, 107],
                                }
  }
}

impl Default for WithdrawRentInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct WithdrawRentInstructionArgs {
                  pub amount: u64,
      }


/// Instruction builder for `WithdrawRent`.
///
/// ### Accounts:
///
                ///   0. `[signer]` admin
...
pub struct WithdrawRentBuilder {
...
impl WithdrawRentBuilder {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = WithdrawRent {
          ...
          let args = WithdrawRentInstructionArgs {
  ...
  /// `withdraw_rent` CPI accounts.
  pub struct WithdrawRentCpiAccounts<'a, 'b> {
...
/// `withdraw_rent` CPI instruction.
pub struct WithdrawRentCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: WithdrawRentInstructionArgs,
  }

impl<'a, 'b> WithdrawRentCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: WithdrawRentCpiAccounts<'a, 'b>,
...
/// Instruction builder for `WithdrawRent` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` admin
          ...
          ///   4. `[]` program
#[derive(Clone, Debug)]
pub struct WithdrawRentCpiBuilder<'a, 'b> {
  instruction: Box<WithdrawRentCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawRentCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(WithdrawRentCpiBuilderInstruction {
      __program: program,
              admin: None,
              uln: None,
              receiver: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = WithdrawRentCpi {
...
#[derive(Clone, Debug)]
struct WithdrawRentCpiBuilderInstruction<'a, 'b> {
