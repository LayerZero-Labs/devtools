...
impl SetTreasury {
  pub fn instruction(&self, args: SetTreasuryInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetTreasuryInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SetTreasuryInstructionData::new()).unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetTreasuryInstructionArgs {
...
#[inline(always)]
    ...
    pub fn program(&mut self, program: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    /// `[optional argument]`
#[inline(always)]
      pub fn treasury(&mut self, treasury: Treasury) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SetTreasury {
          ...
          let args = SetTreasuryInstructionArgs {
...
pub struct SetTreasuryCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SetTreasuryInstructionArgs,
  }
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = SetTreasuryInstructionArgs {
                                                              treasury: self.instruction.treasury.clone(),
                                    };
