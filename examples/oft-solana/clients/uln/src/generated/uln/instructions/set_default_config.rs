...
impl SetDefaultConfig {
  pub fn instruction(&self, args: SetDefaultConfigInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetDefaultConfigInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SetDefaultConfigInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetDefaultConfigInstructionData {
            discriminator: [u8; 8],
                              }

impl SetDefaultConfigInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [111, 228, 17, 75, 5, 76, 213, 169],
                                                                          }
  }
}

impl Default for SetDefaultConfigInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetDefaultConfigInstructionArgs {
                  pub eid: u32,
...
/// Instruction builder for `SetDefaultConfig`.
///
/// ### Accounts:
///
                ///   0. `[signer]` admin
...
pub struct SetDefaultConfigBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SetDefaultConfig {
          ...
          let args = SetDefaultConfigInstructionArgs {
                                                              eid: self.eid.clone().expect("eid is not set"),
                                                                  send_uln_config: self.send_uln_config.clone(),
                                                                  receive_uln_config: self.receive_uln_config.clone(),
  ...
  /// `set_default_config` CPI accounts.
  pub struct SetDefaultConfigCpiAccounts<'a, 'b> {
...
/// `set_default_config` CPI instruction.
pub struct SetDefaultConfigCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SetDefaultConfigInstructionArgs,
  }

impl<'a, 'b> SetDefaultConfigCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: SetDefaultConfigCpiAccounts<'a, 'b>,
...
/// Instruction builder for `SetDefaultConfig` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` admin
          ...
          ///   5. `[]` program
#[derive(Clone, Debug)]
pub struct SetDefaultConfigCpiBuilder<'a, 'b> {
  instruction: Box<SetDefaultConfigCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetDefaultConfigCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SetDefaultConfigCpiBuilderInstruction {
      __program: program,
              admin: None,
              uln: None,
              send_config: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = SetDefaultConfigInstructionArgs {
                                                              eid: self.instruction.eid.clone().expect("eid is not set"),
                                                                  send_uln_config: self.instruction.send_uln_config.clone(),
                                                                  receive_uln_config: self.instruction.receive_uln_config.clone(),
                                                                  executor_config: self.instruction.executor_config.clone(),
                                    };
        let instruction = SetDefaultConfigCpi {
...
#[derive(Clone, Debug)]
struct SetDefaultConfigCpiBuilderInstruction<'a, 'b> {
