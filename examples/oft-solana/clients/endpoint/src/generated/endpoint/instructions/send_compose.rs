...
impl SendCompose {
  pub fn instruction(&self, args: SendComposeInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SendComposeInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SendComposeInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SendComposeInstructionData {
            discriminator: [u8; 8],
                              }

impl SendComposeInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [75, 38, 228, 168, 43, 39, 238, 229],
                                                                          }
  }
}

impl Default for SendComposeInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SendComposeInstructionArgs {
                  pub to: Pubkey,
                pub guid: [u8; 32],
                pub index: u16,
                pub message: Vec<u8>,
...
/// Instruction builder for `SendCompose`.
///
/// ### Accounts:
///
                ///   0. `[signer]` from
                      ///   1. `[writable, signer]` payer
                ///   2. `[writable]` compose_message
                ///   3. `[optional]` system_program (default to `11111111111111111111111111111111`)
          ///   4. `[]` event_authority
          ///   5. `[]` program
#[derive(Clone, Debug, Default)]
pub struct SendComposeBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SendCompose {
          ...
          let args = SendComposeInstructionArgs {
  ...
  /// `send_compose` CPI accounts.
  pub struct SendComposeCpiAccounts<'a, 'b> {
...
/// `send_compose` CPI instruction.
pub struct SendComposeCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SendComposeInstructionArgs,
  }

impl<'a, 'b> SendComposeCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: SendComposeCpiAccounts<'a, 'b>,
...
/// Instruction builder for `SendCompose` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` from
          ...
          ///   5. `[]` program
#[derive(Clone, Debug)]
pub struct SendComposeCpiBuilder<'a, 'b> {
  instruction: Box<SendComposeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SendComposeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SendComposeCpiBuilderInstruction {
      __program: program,
              from: None,
              payer: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = SendComposeCpi {
...
#[derive(Clone, Debug)]
struct SendComposeCpiBuilderInstruction<'a, 'b> {
