...
/// Accounts.
#[derive(Debug)]
pub struct SetDefaultReceiveLibrary {
...
impl SetDefaultReceiveLibrary {
  pub fn instruction(&self, args: SetDefaultReceiveLibraryInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetDefaultReceiveLibraryInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SetDefaultReceiveLibraryInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetDefaultReceiveLibraryInstructionData {
            discriminator: [u8; 8],
                        }

impl SetDefaultReceiveLibraryInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [14, 162, 167, 212, 13, 20, 151, 129],
                                                            }
  }
}

impl Default for SetDefaultReceiveLibraryInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetDefaultReceiveLibraryInstructionArgs {
                  pub eid: u32,
                pub new_lib: Pubkey,
...
/// Instruction builder for `SetDefaultReceiveLibrary`.
///
/// ### Accounts:
///
                ///   0. `[signer]` admin
...
pub struct SetDefaultReceiveLibraryBuilder {
...
impl SetDefaultReceiveLibraryBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SetDefaultReceiveLibrary {
          ...
          let args = SetDefaultReceiveLibraryInstructionArgs {
  ...
  /// `set_default_receive_library` CPI accounts.
  pub struct SetDefaultReceiveLibraryCpiAccounts<'a, 'b> {
...
/// `set_default_receive_library` CPI instruction.
pub struct SetDefaultReceiveLibraryCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SetDefaultReceiveLibraryInstructionArgs,
  }

impl<'a, 'b> SetDefaultReceiveLibraryCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: SetDefaultReceiveLibraryCpiAccounts<'a, 'b>,
...
/// Instruction builder for `SetDefaultReceiveLibrary` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` admin
          ...
          ///   5. `[]` program
#[derive(Clone, Debug)]
pub struct SetDefaultReceiveLibraryCpiBuilder<'a, 'b> {
  instruction: Box<SetDefaultReceiveLibraryCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetDefaultReceiveLibraryCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SetDefaultReceiveLibraryCpiBuilderInstruction {
      __program: program,
              admin: None,
              endpoint: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = SetDefaultReceiveLibraryCpi {
...
#[derive(Clone, Debug)]
struct SetDefaultReceiveLibraryCpiBuilderInstruction<'a, 'b> {
