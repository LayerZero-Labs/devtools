...
impl QuoteSend {
  pub fn instruction(&self, args: QuoteSendInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: QuoteSendInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&QuoteSendInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct QuoteSendInstructionData {
            discriminator: [u8; 8],
                                                }

impl QuoteSendInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [207, 0, 49, 214, 160, 211, 76, 211],
                                                                                                                    }
  }
}

impl Default for QuoteSendInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct QuoteSendInstructionArgs {
                  pub dst_eid: u32,
                pub to: [u8; 32],
                pub amount_ld: u64,
...
/// Instruction builder for `QuoteSend`.
///
/// ### Accounts:
///
          ///   0. `[]` oft_store
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = QuoteSend {
          ...
          let args = QuoteSendInstructionArgs {
  ...
  /// `quote_send` CPI accounts.
  pub struct QuoteSendCpiAccounts<'a, 'b> {
...
/// `quote_send` CPI instruction.
pub struct QuoteSendCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: QuoteSendInstructionArgs,
  }

impl<'a, 'b> QuoteSendCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: QuoteSendCpiAccounts<'a, 'b>,
...
/// Instruction builder for `QuoteSend` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` oft_store
          ...
          ///   2. `[]` token_mint
#[derive(Clone, Debug)]
pub struct QuoteSendCpiBuilder<'a, 'b> {
  instruction: Box<QuoteSendCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> QuoteSendCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(QuoteSendCpiBuilderInstruction {
      __program: program,
              oft_store: None,
              peer: None,
              token_mint: None,
...
#[derive(Clone, Debug)]
struct QuoteSendCpiBuilderInstruction<'a, 'b> {
