...
task(
    ...
    'Configure ULN receive side to use your SimpleDVNMock for both ULN and Executor'
)
    ...
    .addOptionalParam('dvn', 'SimpleDVNMock address', undefined, types.string) // default value obtained from SimpleDVNMock deployment
