module oft::oft_impl_config {
    ...
    public(friend) fun get_fee_bps(): u64 acquires Config { store().fee_bps }
    ...
    #[test_only]
    public fun blocklist_set_event(wallet: address, blocklist: bool): BlocklistSet {
        BlocklistSet { wallet, blocklist }
    }
    ...
    const EEXCEEDED_RATE_LIMIT: u64 = 2;
    const EINVALID_FEE: u64 = 3;
    const EINVALID_WINDOW: u64 = 4;
    const ESETTING_UNCHANGED: u64 = 5;
    const ESLIPPAGE_EXCEEDED: u64 = 6;
}
