...
import { PreCrime, PreCrimePeer } from "@layerzerolabs/oapp-evm/contracts/precrime/PreCrime.sol";
...
contract OmniCounterPreCrime is PreCrime {
    ...
    constructor(address _endpoint, address _counter) PreCrime(_endpoint, _counter) Ownable(msg.sender) {}
