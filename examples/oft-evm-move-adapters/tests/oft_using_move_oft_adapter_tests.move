#[test_only]
module oft::oft_using_move_oft_adapter_tests {
    ...
    use oft::move_oft_adapter::{set_fee_bps, set_rate_limit};
    use oft::oft_store;
    ...
    fun test_send_fa_with_fee() {
        ...
        oft::move_oft_adapter::set_fee_deposit_address(&create_signer_for_test(@oft_admin), @9999);
