...
const contractName_oft = 'WrappedHyperliquidOFT'
...
const deploy: DeployFunction = async (hre) => {
    ...
    console.log(
        `Deployed WrappedHyperliquidOFT contract: ${contractName_oft}, network: ${hre.network.name}, address: ${address_oft}`
    )
...
// WrappedHyperliquidOFT-hyperliquid
