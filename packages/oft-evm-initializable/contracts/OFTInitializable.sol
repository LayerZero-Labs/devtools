 ...
 */
abstract contract OFTInitializable is Initializable, ERC20Upgradeable, OFTCoreInitializable {
    /**
     ...
     */
    function initialize(string memory _name, string memory _symbol, uint8 _localDecimals) public initializer {
        // Initialize ERC20
