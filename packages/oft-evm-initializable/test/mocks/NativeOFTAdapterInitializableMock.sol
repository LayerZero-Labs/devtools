...
contract NativeOFTAdapterInitializableMock is NativeOFTAdapterInitializable {
    constructor(
        uint8 _localDecimals,
        address _lzEndpoint,
        address _delegate
    ) NativeOFTAdapterInitializable(_localDecimals, _lzEndpoint, _delegate) Ownable(_delegate) {}
