...
contract VaultComposerSyncPoolNativeForkTest is Test {
    ...
    function setUp() public {
        ...
        composer = new VaultComposerSyncPoolNative(
            ...
            defaultRecoveryAddress // HUB_RECOVERY_ADDRESS
        );
        vm.stopPrank();
        ...
        vm.label(defaultRecoveryAddress, "RecoveryAddress");
    ...
    function test_forkPoolNativeFailedDepositFromArbPool() public {
        ...
        /// @dev We cause the revert by sending less than the minimum expected msg.value
    ...
    function test_forkPoolNativeRedeemToArbPool() public {
        ...
        assetERC20.deposit{ value: amtToMint }();
