...
import { AbiFactoryHardhat, OmniContractFactoryHardhat, OmniDeployment } from './types'
...
export const createAbiFactory = (environmentFactory = createGetHreByEid()): AbiFactoryHardhat => {
